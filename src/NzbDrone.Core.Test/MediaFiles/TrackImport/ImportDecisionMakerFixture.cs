    ...
    public class ImportDecisionMakerFixture : FileSystemTest<ImportDecisionMaker>
    {
        ...
        public void Setup()
        {
            ...
            Mocker.GetMock<IIdentificationService>()
                .Setup(s => s.Identify(It.IsAny<List<LocalTrack>>(), It.IsAny<Artist>(), It.IsAny<Album>(), It.IsAny<AlbumRelease>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<ImportArtistDefaults>()))
        ...
        public void should_call_all_album_specifications()
        {
            ...
            Subject.GetImportDecisions(_fileInfos, new Artist(), null, null, downloadClientItem, null, FilterFilesType.None, false, false, false, null);
        ...
        public void should_return_rejected_if_only_album_spec_fails()
        {
            ...
            var result = Subject.GetImportDecisions(_fileInfos, new Artist(), FilterFilesType.None, false, null);
        ...
        public void should_not_blowup_the_process_due_to_failed_augment()
        {
            ...
            Subject.GetImportDecisions(_fileInfos, _artist, FilterFilesType.None, false, null);
        ...
        public void should_not_throw_if_release_not_identified()
        {
            ...
            var decisions = Subject.GetImportDecisions(_fileInfos, _artist, FilterFilesType.None, false, null);
        ...
        public void should_return_a_decision_when_exception_is_caught()
        {
            ...
            Subject.GetImportDecisions(_fileInfos, _artist, FilterFilesType.None, false, null).Should().HaveCount(1);
